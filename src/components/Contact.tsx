...
export function Contact() {
  return (
    <footer id="contact" className="py-20 px-6 footer">
      <div className="container mx-auto max-w-6xl">
        <div className="text-center mb-12">
          ...
          <p className="text-white/70 max-w-2xl mx-auto mb-8 leading-relaxed">
            ...
            Saya selalu terbuka untuk kolaborasi dan kesempatan baru.
          </p>
          <a
            href="https://wa.me/6282375227802"
            target="_blank"
            rel="noopener noreferrer"
            className="inline-block text-purple-400 hover:text-purple-300 font-medium text-lg transition-colors"
          >
            +62 823 7522 7802
          </a>
        </div>
